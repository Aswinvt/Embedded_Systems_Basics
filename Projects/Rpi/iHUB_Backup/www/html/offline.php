  ...
  <body>
    <div class="container">
      <button class="btn btn-lg btn-primary btn-block"><h2>iHUB-DEVICE ACCESS</h2></button><br />
        <form class="form-signin" name="form1" action="http:\/\/192.168.1.200:8082/file_manager.php" method="POST" accept-charset="utf-8">    <!-- change action to desired address -->
        <button name="online" id="submit" class="btn btn-lg btn-primary btn-block" type="submit">USB STORAGE DEVICES</button>
        </form>
        <form class="form-signin" name="form2" action="http:\/\/192.168.1.200:8081" method="POST" accept-charset="utf-8"> <!-- change action to desired address -->
        <button name="offline" id="submit" class="btn btn-lg btn-primary btn-block" type="submit">CAMERA</button>
        </form>
        <form class="form-signin" name="form3" action="http:\/\/192.168.1.200:631" method="POST" accept-charset="utf-8"> <!-- change action to desired address -->
