...
if (strlen($fm_root)) $fm_current_root = $fm_root;
    ...
    if ($is_windows) {
        ...
        $fm_current_root = "/home/pi/iHUB"; // Linux default show root
    }
}
...
function frame2(){
    ...
    echo "<form style=\"display:inline-block;margin-top:-2px;\" action=\"".$fm_path_info["basename"]."\" method=\"post\" target=\"_parent\">";
        ...
        echo "&nbsp<input type=button value=".et('Refresh')." onclick=\"refresh_tree()\"> &nbsp&nbsp";
        echo "<a href=\"options.php\" target=\"_blank\">Options</a>";
